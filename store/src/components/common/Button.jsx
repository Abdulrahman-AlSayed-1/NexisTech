 ...
 * @property {ButtonVariant} [variant='primary'] - Visual appearance variant
 * @property {ButtonSize} [size='md'] - Button size scale
 * @property {boolean} [isLoading=false] - When true, shows an accessible animated spinner and disables clicks
 * @property {boolean} [disabled=false] - Disables interaction and lowers opacity
 * @property {string} [className=''] - Additional Tailwind CSS classes
 * @property {'button' | 'submit' | 'reset'} [type='button'] - Semantic HTML button type
 */

/**
 * Common Button Primitive
 * Consistently styled using design system tokens with full keyboard & screen-reader accessibility.
 *
