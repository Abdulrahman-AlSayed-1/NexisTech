 ...
 * @property {number} [currentPage=1] - 1-based index of the active page
 * @property {number} [totalPages=1] - Total page count
 * @property {number} [totalItems=0] - Total count of items across all pages
 * @property {number} [pageSize=12] - Number of items shown per page
 * @property {string} [itemLabel='items'] - Plural entity label (e.g., 'products', 'orders')
 * @property {(page: number) => void} [onPageChange] - Callback when page selection changes
 * @property {string} [className=''] - Additional CSS classes
 */

/**
 * Common Pagination Primitive
